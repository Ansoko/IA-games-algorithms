...
public class human : MonoBehaviour
{
    ...
    public List<human> Neighbors = new(); //liste des voisins du boid
    private List<human> boidlist = new(); //liste de tous les boids de la scène
    ...
    public void ToZombie()
    {
        ...
        audioSource.PlayOneShot(tuningZombie);
